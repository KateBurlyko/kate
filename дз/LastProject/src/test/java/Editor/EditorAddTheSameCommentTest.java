...
/**
 * editor add two same comments
 */
@Test(singleThreaded = true)
public class EditorAddTheSameCommentTest {
    ...
    public void setUp() throws InterruptedException {
        ...
        driver.findElement(By.id("title")).sendKeys("MySQL Editions");
        driver.findElement(By.id("content")).sendKeys("MySQL is the world's most popular open source database. Whether you are a fast growing web property, technology ISV or large enterprise," +
    ...
    @Test
    public void testaddTheSameComment() {
